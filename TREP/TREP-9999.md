...
- as the TREP author, fork the [TREP repository](https://github.com/thinkingrock-gtd/tr-discuss-governance),
  and create a file named TREP/TREP-9999.md containing your new TREP.
  Use the temporary “9999” as your draft TREP number.
- In the “Status:” header field enter “Draft”.
- Push your changes to your GitHub fork and submit a pull request.
- The TR core team reviews your PR for structure, formatting, and other errors.
  Use TREP-7 as a template.
- Once approved, the TR core team will assign your TREP a final and unique number and put it on the "TREP:" header; will add the current day (in yyyy-mm-dd format) to the "Created:" header  and will squash merge your pull request into the main branch.
