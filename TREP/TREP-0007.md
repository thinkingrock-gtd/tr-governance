...
- Once the TREP is getting ready to be merged, the TR core team sponsor determines the next free TREP number,
  assigns the number to the current TREP (typically in a comment in the pull request).
