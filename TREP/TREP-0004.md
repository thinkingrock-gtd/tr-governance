...
This document specifies the code of conduct that will be used by all project on the ThinkingRock organization.
...
The code of conduct chosen for all the projects in the ThinkinRock organization is the Contributor Covenant.
...
In the "Enforcing" section, the Contributor Covenant says:
